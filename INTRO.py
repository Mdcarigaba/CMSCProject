...
def rules(name):
    ...
    if ch.lower() == "english":
        ...
        time.sleep(2)
        print("There 5 questions each for the Easy, Average, and Difficult rounds, resulting to a total of 15 questions.\n")
        time.sleep(2)
        ...
        time.sleep(2)
        print("Magsisimula ang halaga nito mula 1,000 pesos paakayt ng 1,000,000 pesos\n")
        time.sleep(2)
        print("Bago magsimula ang isang tanong, maaari kang umuwi na lamang kasama ang lahat ng napanalunan mo.\n")
        time.sleep(2)
        print("Kapag mali ang iyong sagot, iuuwi mo ang 1/4 ng napanalanun mo.\n")
        time.sleep(4)
        ...
        time.sleep(2)
        print("Ikaw parin huling desisyon kung paniniwalaan mo ang sagot nila o hindi.\n")
        time.sleep(3)
        print("50/50: \n")
        time.sleep(2)
